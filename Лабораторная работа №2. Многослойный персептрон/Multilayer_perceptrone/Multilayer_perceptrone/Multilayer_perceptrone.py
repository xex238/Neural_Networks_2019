...
percentrone = class_perceptrone.multilayer_perceptrone(Roma_dataset_path, count_of_layers, test_probability, validation_probability, activation_function, neurons_hidden, count_of_eras, speed)
